...
import { CheckCircle2, ChevronRight, Clock, MessageSquareHeart, Megaphone, CalendarDays, Share2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="rounded-2xl border bg-card p-5 space-y-1">
          ...
          {FIRST_WEEK_STEPS.map(({ step, icon: Icon, label, tutorial, link }) => (
